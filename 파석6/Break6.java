...
public class Break6 {
    public static void main(String[] args) {
        ...
        Mon1 qauil = new Mon1("메추리",1,10,10,10,10,10,10);
        Mon2 goose = new Mon2("거위알",2,20,20,20,20,20,20);
        Mon3 tree = new Mon3("나무",3,300,300,300,300,300,300) ;
        Mon4 rack = new Mon4("바위",4,400,400,4000,400,400,400);
